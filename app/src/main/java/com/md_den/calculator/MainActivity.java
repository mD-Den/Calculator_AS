...
public class MainActivity extends AppCompatActivity {
    ...
    public void clickPlus(View view) {
        ...
        TextView textView = (TextView) findViewById(R.id.main_text);
        arrayList.add(Double.parseDouble(textView.getText().toString()));
        textView.setText("0");
        isNextClear = true;
    }
    ...
    public void clickInterest(View view) {
        ...
        arrayList.add(Double.parseDouble(textView.getText().toString()));
        switch (mathActivity) {
            case PLUS : result = arrayList.get(arrayList.size() - 2) + (arrayList.get(arrayList.size() - 2) / 100) * arrayList.get(arrayList.size() - 1);
            break;
            case MINUS : result = arrayList.get(arrayList.size() - 2) - (arrayList.get(arrayList.size() - 2) / 100) * arrayList.get(arrayList.size() - 1);
            break;
            case DIVISION : {
                result = (arrayList.get(arrayList.size() - 2)) / ((arrayList.get(arrayList.size() - 1)) / 100);
                if (Double.isInfinite(result)) {
                    result = 0.0;
                }
            }
            break;
            case MULTIPLICATION : result = (arrayList.get(arrayList.size() - 2)) * (arrayList.get(arrayList.size() - 1) / 100);
            break;
            case NONE :result = arrayList.get(arrayList.size() - 1) / 100;
            break;
        }
    ...
    public void total(View view) {
        TextView textView = (TextView) findViewById(R.id.main_text);
        switch (mathActivity) {
            case PLUS: textView = (TextView) findViewById(R.id.main_text);
                arrayList.add(Double.parseDouble(textView.getText().toString()));
                result = arrayList.get(arrayList.size() - 2) + arrayList.get(arrayList.size() - 1);
                break;
            case MINUS:
                ...
                result = arrayList.get(arrayList.size() - 2) - arrayList.get(arrayList.size() - 1);
                break;
            case DIVISION: textView = (TextView) findViewById(R.id.main_text);
                arrayList.add(Double.parseDouble(textView.getText().toString()));
                result = arrayList.get(arrayList.size() - 2) / arrayList.get(arrayList.size() - 1);
                break;
            case MULTIPLICATION: textView = (TextView) findViewById(R.id.main_text);
                arrayList.add(Double.parseDouble(textView.getText().toString()));
                result = arrayList.get(arrayList.size() - 2) * arrayList.get(arrayList.size() - 1);
                break;
        }
